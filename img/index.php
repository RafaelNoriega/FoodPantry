...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="index.html">Food Pantry Dashboard</a>
    ...
    <div class="container-fluid">
        ...
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card text-white bg-primary o-hidden h-100">
            <div class="card-body">
              ...
              <div class="mr-5">10 New Users!</div>
            </div>
        ...
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card text-white bg-warning o-hidden h-100">
            <div class="card-body">
              ...
              <div class="mr-5">11 New Resource Request!</div>
            </div>
            <a class="card-footer text-white clearfix small z-1" href="#">
              <span class="float-left">View Details</span>
              <span class="float-right">
        ...
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card text-white bg-success o-hidden h-100">
            <div class="card-body">
              ...
              <div class="mr-5">2 New Donation Request!</div>
            </div>
            <a class="card-footer text-white clearfix small z-1" href="#">
              <span class="float-left">View Details</span>
              <span class="float-right">
      ...
      <div class="row">
        <div class="col-lg-8">
          ...
          <div class="card mb-3">
            <div class="card-header">
              <i class="fa fa-bar-chart"></i> Users</div>
            <div class="card-body">
              <div class="row">
        ...
        <div class="col-lg-4">
          ...
          <div class="card mb-3">
            <div class="card-header">
              <i class="fa fa-pie-chart"></i> Majors</div>
            <div class="card-body">
    ...
    <div class="col-lg-8 padding">
      ...
      <div class="form-group g-mb-25">
          <label for="1pt">1pt Items</label>
            ...
            <option value="1">2 Items</option>
            <option value="2">3 Items</option>
      ...
      <div class="submit-middle-0">
        <button class="btn btn-lg u-btn-primary rounded-0" type="submit" name="submit"  id="submit"> Checkout! </button>
      </div>
...
// <?php
    ...
    //This will give is the majors and the amount of users corresponding to them
      // $sql = "SELECT count(major) as amount, major  from users group by major ASC;";
      // $result = pg_query($db, $sql);
      // while($row = pg_fetch_array($result))
      // {
      //   $majorsList .= $row['major'] . ",";
      ...
      // $line.=']';
      //var_dump($line); 
      //["Computer Science", "Business", "Art", "Psychology"]
      // echo $line;
      // echo ",datasets: [{ data:";
      // $line2 = '';
      // $line2 .= '[';
      ...
      //this will assign a color to every major on the pie chart
      // $myColors = array('#007bff', '#dc3545', '#ffc107', '#28a745' , '#3kdb93');
      // $colors='[';
      // while($i)
      // {
      //   $colors .= $myColors[i].",";
